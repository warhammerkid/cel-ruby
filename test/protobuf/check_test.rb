...
class CelProtobufCheckTest < Minitest::Test
  def test_literal_expression
    ...
    assert_equal environment.check("google.protobuf.Duration{seconds: 123}.seconds"), :int
    assert_equal environment(duration: Google::Protobuf::Duration).check("duration.seconds"), Cel::TYPES[:int]
  end
